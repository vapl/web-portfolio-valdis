...
export default function ProjectSlide({ abbreviation, image, slug}: ProjectSlideProps) {
    return (
        <div className='relative w-full h-screen overflow-hidden flex items-center justify-center text-white'>
            ...
            <div className="absolute text-8xl front-light tracking-widest flex flex-col items-center">
